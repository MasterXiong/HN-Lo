...
class RtRobotDataset(tfds.core.GeneratorBasedBuilder):
                ...
                'steps': tfds.features.Dataset({
                    ...
                    'action': tfds.features.FeaturesDict({
                        ...
                        'rotation_delta': tfds.features.Tensor(
                            shape=(3,),
                            dtype=np.float32,
                            doc='End effector orientation',
                        ),
                        'gripper_closedness_action': tfds.features.Tensor(
                            shape=(1,),
                            dtype=np.float32,
                            doc='End effector change condition',
                        ),
                    }),
            ...
            for i, step in enumerate(data):
                ...
                episode.append({
                    ...
                    'action': {
                        ...
                        'gripper_closedness_action': step['action']['gripper_closedness_action'], 
                    },
                    'discount': 1.0,
